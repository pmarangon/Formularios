...
<html>
    ...
    <body>
        ...
        if (!empty($dados['CadUsuario'])) {
            ...
            if (!$empty_input) {
                $query_usuario = "INSERT INTO escola (nome, tipo, email,  senha) VALUES (:nome, :tipo, :email,:senha) ";
        ...
        <form name="cad-usuario" method="POST" action="">
            ...
            ?>"><br><br>
            <label>Tipo: </label>
            <input type="text" name="tipo" id="tipo" placeholder="Publica ou privada" value="<?php
            if (isset($dados['tipo'])) {
                echo $dados['tipo'];
            }
            ?>"><br><br>
