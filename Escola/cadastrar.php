...
<html>
    ...
    <body>
        ...
        if (!empty($dados['CadUsuario'])) {
            ...
            if (!$empty_input) {
                $query_usuario = "INSERT INTO escola (nome,tipo, email,senha) VALUES (:nome, :email, :tipo, :senha) ";
        ...
        <form name="cad-usuario" method="POST" action="">
            ...
            ?>
 	        <label>Tipo: </label>
            <input type="email" name="email" id="email" placeholder="Publica ou privada" value="<?php
            if (isset($dados['tipo'])) {
                echo $dados['tipo'];
            }
	        <label>E-mail: </label>
            <input type="password" name="senha" id="senha" placeholder="Escolha uma senha" value="<?php
